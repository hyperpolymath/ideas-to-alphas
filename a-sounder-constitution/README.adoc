...
dependencies). The Idris2 module type-checks cleanly under Idris2 0.7.0
(`idris2 --check formal/Constitution.idr`, exit 0) — see `formal/README.adoc`
for the verification details and graduation criteria.
