...
// Replace rsr-template-repo, ideas-to-alphas, {{DEPS}} with actuals
...
| `$PREFIX/share/ideas-to-alphas/`
| Data files, assets

| `$PREFIX/share/doc/ideas-to-alphas/`
| Documentation
...
Default config location: `$XDG_CONFIG_HOME/ideas-to-alphas/config.toml`

Fallback: `$HOME/.config/ideas-to-alphas/config.toml`
...
Or via OPSM: `opsm update ideas-to-alphas`
...
[source,bash]
----
just install --prefix=/opt/ideas-to-alphas-instance1 --config=/etc/ideas-to-alphas/instance1.toml
just install --prefix=/opt/ideas-to-alphas-instance2 --config=/etc/ideas-to-alphas/instance2.toml
----
